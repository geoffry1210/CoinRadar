...
function shrinkImage(url) {
  ...
  // it, bg=white avoids a transparent-PNG-on-dark-theme issue. A wider,
  // shorter canvas makes Telegram render noticeably less vertical height
  // in the chat, since it sizes photo bubbles by aspect ratio.
  return `https://images.weserv.nl/?url=${encoded}&w=500&h=110&fit=contain&bg=white`;
}
